    ...
    init() {
        ...
        observers.append(NotificationCenter.default.addObserver(
            ...
            if UserDefaults.standard.bool(forKey: "General.icloudSync") {
                cloudDescription.cloudKitContainerOptions = NSPersistentCloudKitContainerOptions(containerIdentifier: "iCloud.tech.gentleflow.Aidoku")
            } else {
    ...
    lazy var container: NSPersistentCloudKitContainer = {
        ...
        if UserDefaults.standard.bool(forKey: "General.icloudSync") {
            cloudDescription.cloudKitContainerOptions = NSPersistentCloudKitContainerOptions(
                containerIdentifier: "iCloud.tech.gentleflow.Aidoku")
        } else {
            cloudDescription.cloudKitContainerOptions = nil
        }
